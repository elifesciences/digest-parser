...
class TestJats(unittest.TestCase):
    ...
    def test_html_to_xml(self):
        ...
        expected_content = ("<bold>A <italic>simple</italic> example</bold> to test &gt; 1 " +
                            "&amp; &lt;blink&gt;check&lt;/blink&gt;.")
    ...
    def test_xml_to_html(self):
        ...
        xml_content = ("<bold>A <italic>simple</italic> example</bold> to test &gt; 1 &amp; " +
                       "<blink>check</blink>.")
        expected_content = ("<b>A <i>simple</i> example</b> to test &gt; 1 &amp; &lt;blink&gt;" +
                            "check&lt;/blink&gt;.")
